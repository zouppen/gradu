...
asiayhteydessä. Se yhdistetään usein uusiin dynaamisiin web-teknologioihin ja internet-
...
Web-pohjaiset sovellukset ovat saaneet yhä suurempaa huomiota yrityspuolen
...
kustannussäästöihin. Sen tuomiin etuihin kuuluu myös muun muassa uusien toimintojen
...
enemmän huomiota, sillä se tarjoaa hakkereille entistä monipuolisemman hyökkäyspinnan. Tietoturvan 
kannalta onkin tärkeää, että kumpaankin hyökkäystapaan kiinnitetään huomiota.

\subsection{Web-alustojen turvaaminen}
...
usein vain hylätään koko syöte, jos se ei vastaa odotettua syötettä \cite{SQLSS}.
...
keinoja, ja harvoin käyttäjä edes huomaa joutuneensa hyökkäyksen kohteeksi. Hyökkäyksen onnistuessa web-sivujen käyttämä Same Origin -periaate 
