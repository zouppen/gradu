...
% Tähän lukuun toivottiin seminaarissa selkeämpää mainintaa, että
% kyseessä on ylläpitäjän ja kehittäjän tietoturva eikä käyttäjän.
% Toisaalta gradun osana varmaan käy ilmi, joten ei välttämättä
% tarvitse? Vai? -Joel
...
% TODO: Ylläolevaan lukuun toivottiin viitettä LiveScriptin historiaan.
...
\subsection{Evästeiden kaappaaminen}
...
\ifdefined\seminaari \relax \else % Graduseminaarissa ei tätä lukua.
