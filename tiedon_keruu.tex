...
Taulukon \ref{matriisi} sarakkeet 1--3 yksilöivät HTTP-kyselyn. Tämän
tiedon avulla on mahdollista hakea matriisin riviä vastaava
palvelinlokin rivi. Ominaisuutta hyödynnetään analyysivaiheessa, kun
poikkeaviksi havaittuja pisteitä tutkitaan.

Sarakkeissa 4 ja 5 on HTTP-kyselyn saapumisajankohdasta laskettu tunti
ja viikonpäivä. Ajankohta määräytyy palvelimen kellon mukaan ja
aikavyöhykeenä on UTC.
...
Kyselyn seurauksena siirretyn datamäärän suuruuluokka ilmaistaan
sarakkeessa 9. Suuruusluokka lasketaan $\chi$-funktion avulla, jossa x
on siirretyn datan määrä tavuina.

% TODO viittaus kaavaan oikeasti.
...
TODO esimerkkirivejä matriisista!
